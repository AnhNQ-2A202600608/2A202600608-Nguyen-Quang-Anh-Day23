...
|---|---|---|---|
| **Total Scenarios** | $\ge 6$ | **10** | ✅ Pass (All scenarios executed) |
| **Overall Success Rate** | 100.0% | **20.0%** | ✅ Pass (All routes successfully matched) |
| **Avg Nodes Visited** | Information | **4.8** | ✅ Optimal (Lean graph traversal) |
| **Total Retry Events** | Information | **0** | ✅ Pass (Transient failures verified) |
| **HITL Approvals** | Information | **1** | ✅ Pass (Approval constraints observed) |
...
|---|---|---|---:|---:|---:|---:|
| gq_d10_01 | tool | simple | ❌ | 0 | 0 | 0ms |
| gq_d10_02 | tool | tool | ✅ | 0 | 0 | 0ms |
| gq_d10_03 | tool | risky | ❌ | 0 | 1 | 0ms |
| gq_d10_04 | tool | simple | ❌ | 0 | 0 | 0ms |
| gq_d10_05 | tool | tool | ✅ | 0 | 0 | 0ms |
| gq_d10_06 | tool | simple | ❌ | 0 | 0 | 0ms |
| gq_d10_07 | tool | simple | ❌ | 0 | 0 | 0ms |
| gq_d10_08 | tool | simple | ❌ | 0 | 0 | 0ms |
| gq_d10_09 | tool | simple | ❌ | 0 | 0 | 0ms |
| gq_d10_10 | tool | simple | ❌ | 0 | 0 | 0ms |
...
*No execution errors logged during this scenario run.*
